...
namespace jcPimSoftware
{
    class App_Cnfgs
    {
        ...
        internal int NecTime
        {
            get { return necTime; }
            set {necTime = value; }
        }
        internal string LT_Path
        {
            get { return lt_path; }
            set { lt_path = value; }
        }
        ...
        internal void LoadSettings()
        {
            ...
            necTime = int.Parse(IniFile.GetString("cnfgs", "NecTime", "0"));
            lt_path = IniFile.GetString("cnfgs", "LT_Path", "D:\\");
            ...
            nofilter = int.Parse(IniFile.GetString("cnfgs", "Nofilter", "0"));
